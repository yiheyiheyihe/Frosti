...
description: Vue学习笔记
pubDate: 09 15 2024
image: https://free2.yunpng.top/2024/09/15/66e664965fb02.png
categories:
  - tech
tags:
  - Blog
...
我们可以使用一个`v-for` 指令基本于一个数组来渲染一个列表，`v-for` 指令的值需要使用`item of items`形式的特殊语法，其中 `item` 是<mark>迭代器</mark> ，`item` 源数据  
